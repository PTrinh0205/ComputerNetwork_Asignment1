...
class Request():
    ...
    def prepare(self, request, routes=None):
        ...
        raw_headers_str, self._raw_body = self.fetch_headers_body(request)
        ...
        # parse cookie header thành dict để dùng tiện hơn
        # vd: "session=abc; user=admin" → {"session": "abc", "user": "admin"}
        cookie_str = self.headers.get("cookie", "") if self.headers else ""
        self.cookies = {}
